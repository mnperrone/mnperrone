...
|-----------------------------------|---------------------------------------|--------------|------|
| **Laravel 11 Tasks API**          | Laravel 11 · PostgreSQL · Redis · JWT · Queues · Swagger · Docker | Producción-ready | [laravel-11-tasks-api](https://github.com/mnperrone/laravel-11-tasks-api) |
...
**Otros**  
Python (Tkinter, Ollama, LangChain) · Moodle Plugins · REST/SOAP APIs · SOLID · Clean Architecture  
...
## Formación
- Maestría en Tecnología Informática Aplicada en Educación – UNLP (en curso)  
- Licenciatura en Ciencias de la Educación – UNAHUR (2023)
